...
describe('Collapse.vue', () => {
  beforeAll(() => {
    ...
    headers = wrapper.findAll('.x-collapse-item__header')
    contents = wrapper.findAll('.x-collapse-item__wapper')
  ...
  test('手风琴模式 错误处理', () => {
    ...
    expect(warn.mock.calls).toMatchInlineSnapshot(
      `
        [
          [
            [XUIError: [XCollapse]:accordion mode should only have one active item],
          ],
        ]
      `
    )
