...
describe('Alert.vue', () => {
  ...
  it('should render the alert with default props', () => {
    ...
    // close icon
    const iconElement = wrapper.findComponent(XIcon)
  ...
  it('should emit close event when close icon is clicked', () => {
    ...
    wrapper.findComponent(XIcon).trigger('click')
  ...
  it('should support centering text', () => {
    ...
    //class
    const rootNode = wrapper.find('.x-alert')
  ...
  it('should not render close icon when closable is false', () => {
    ...
    expect(wrapper.find('.x-alert__close').exists()).toBe(false)
  })
  ...
  it('should toggle visibility when open and close methods are called', async () => {
    ...
    expect(wrapper.find('.x-alert').attributes().style).toBe('display: none;')
    await wrapper.vm.open()
    expect(wrapper.find('.x-alert').attributes().style).toBe('')
  })
})
