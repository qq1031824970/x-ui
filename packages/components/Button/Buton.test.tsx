...
describe('ButtonGroup.vue', () => {
  test('basic button group', async () => {
    ...
    expect(wrapper.classes()).toContain('x-button-group')
  })
  ...
  test('button group size', () => {
    ...
    sizes.forEach((size) => {
      ...
      expect(buttonWrapper.classes()).toContain(`x-button--${size}`)
    })
  })
  ...
  test('button group type', () => {
    ...
    types.forEach((type) => {
      ...
      const buttonWrapper = wrapper.findComponent(Button)
      expect(buttonWrapper.classes()).toContain(`x-button--${type}`)
    })
  })
